...
We have included the solutions to each exercise. The skeleton code and provided APIs are omitted for concision, but can be found at \color{blue}\underline{\url{https://github.com/EvanFredHernandez/byose}} \color{black}.
